...
public class SiteSets {
    ...
    private  static SiteSet four_t_320x160 = new SiteSet(25,25,13,false,0, R.layout.activity_four_tw_320x160,true,true,4,0);
    ...
    private  static SiteSet six_t_256X128 = new SiteSet(18,18,8,false,0, R.layout.activity_six_t_256x128,true,false,6,0);
    private  static SiteSet six_t_192X96 = new SiteSet(21,21,17,false,0, R.layout.activity_six_t_192x96,true,false,6,0);
